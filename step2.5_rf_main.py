...
WESTERN_ACTIVITY_COLS = [
    'TG（甘油三酯）','TC（总胆固醇）','HDL-C（高密度脂蛋白）', 'LDL-C（低密度脂蛋白）', '空腹血糖', '血尿酸', 'BMI',
...
# 痰湿分析特征表
TANSHI_ANALISIS = ['TC_abnormal', 'TG_abnormal', 'LDL_abnormal', 'HDL_abnormal', 'abnormal_lipid_count']
...
# ==================== 主分析函数 ====================
def run_analysis(feature_set, data_dir, output_dir):
    """
    执行随机森林分析
